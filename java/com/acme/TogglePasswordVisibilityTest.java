 ...
 */
public class TogglePasswordVisibilityTest {
    ...
    @Test
    public void toggleVisibilityOnPasswordForViewPage(){

        driver.findElement(By.xpath("//span[contains(@class, 'glyphicon-eye-open')]")).click();
        WebElement password = driver.findElement(By.cssSelector("input.acmepass-password"));

        assertEquals("TestPass0", password.getAttribute("value"));

        driver.findElement(By.xpath("//span[contains(@class, 'glyphicon-eye-close')]")).click();

        password = driver.findElement(By.cssSelector("input.acmepass-password"));

        assertNotSame("TestPass0", password.getAttribute("value"));
    ...
    @Test
    public void toggleVisibilityOnPasswordForCreateAndEditPage(){

        driver.findElement(By.xpath("//span[contains(@class, 'glyphicon-pencil')]")).click();
        driver.findElement(By.xpath("//span[contains(@class, 'glyphicon-eye-open')]")).click();
        WebElement password = driver.findElement(By.cssSelector("input#field_password"));

        assertEquals("TestPass0", password.getAttribute("value"));

        driver.findElement(By.xpath("//span[contains(@class, 'glyphicon-eye-close')]")).click();

        password = driver.findElement(By.cssSelector("input#field_password"));
